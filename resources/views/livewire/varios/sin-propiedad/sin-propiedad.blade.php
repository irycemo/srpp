<div>
    ...
    <x-header>Varios (sin propiedad)</x-header>
    ...
    <div class="p-4 bg-white shadow-xl rounded-xl mb-5">
        ...
        <div class="flex gap-3 items-center w-full lg:w-1/2 justify-center mx-auto mb-4">
            ...
            <x-input-group for="vario.acto_contenido" label="Acto" :error="$errors->first('vario.acto_contenido')" class="w-full">

                <x-input-text type="text" id="vario.acto_contenido" wire:model="vario.acto_contenido" />
