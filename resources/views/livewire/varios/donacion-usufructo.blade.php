        ...
        <div class="w-full lg:w-1/2 justify-center mx-auto">
            ...
            <div class="my-2 mr-auto w-full">
                ...
                <div class="flex justify-end mb-2">
                    ...
                    @livewire('comun.actores.propietario-crear', ['modelo' => $vario])
                                    ...
                                    <x-table.cell>
                                        <div class="flex items-center gap-3">
                                            <div>
                                                ...
                                                <livewire:comun.actores.propietario-actualizar :actor="$propietario" :predio="$vario" wire:key="button-propietario-{{ $propietario->id }}" />
