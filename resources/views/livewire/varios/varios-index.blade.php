                        ...
                        @if (!auth()->user()->hasRole('Administrador'))
                            ...
                            <x-table.cell>
                                ...
                                <div class="flex justify-center lg:justify-start gap-2">
                                    ...
                                    @if(in_array($movimiento->estado, ['nuevo', 'captura']) && !auth()->user()->hasRole(['Jefe de departamento inscripciones', 'Supervisor varios', 'Supervisor uruapan']))
                                    ...
                                    @elseif($movimiento->estado == 'elaborado'  && !auth()->user()->hasRole(['Jefe de departamento inscripciones', 'Supervisor varios', 'Supervisor uruapan']))
