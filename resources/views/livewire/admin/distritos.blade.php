<div class="">
        ...
        <x-table>
            ...
            <x-slot name="body">
                ...
                @forelse ($distritos as $distrito)
                    ...
                    <x-table.row wire:loading.class.delaylongest="opacity-50" wire:key="row-{{ $distrito->id }}">
                        ...
                        <x-table.cell>
                            ...
                            <span class="font-semibold">@if($distrito->creadoPor != null)Registrado por: {{$distrito->creadoPor->name}} @else Registro: @endif</span> <br>
                        ...
                        <x-table.cell>
                            ...
                            <span class="font-semibold">@if($distrito->actualizadoPor != null)Actualizado por: {{$distrito->actualizadoPor->name}} @else Actualizado: @endif</span> <br>
                            ...
                            <div class="flex justify-center lg:justify-start gap-2">
                                ...
                                @can('Editar distrito')
                                    ...
                                    <x-button-blue
                                        ...
                                        wire:target="abrirModalEditar({{ $distrito->id }})"
                                ...
                                @can('Borrar distrito')
                                    ...
                                    <x-button-red
                                        ...
                                        wire:target="abrirModalBorrar({{ $distrito->id }})"
                                        wire:loading.attr="disabled"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4 mr-2">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
    ...
    <x-confirmation-modal wire:model="modalBorrar" maxWidth="sm">
        ...
        <x-slot name="content">
            ¿Esta seguro que desea eliminar el distrito? No sera posible recuperar la información.
        </x-slot>
