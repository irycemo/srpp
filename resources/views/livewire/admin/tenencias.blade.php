<div class="">
    ...
    <div class="overflow-x-auto rounded-lg shadow-xl border-t-2 border-t-gray-500">
        ...
        <x-table>
            ...
            <x-slot name="head">
                ...
                <x-table.heading sortable wire:click="sortBy('distrito_id')" :direction="$sort === 'distrito_id' ? $direction : null" >Distrito</x-table.heading>
            ...
            <x-slot name="body">
                ...
                @forelse ($tenencias as $tenencia)
                    ...
                    <x-table.row wire:loading.class.delaylongest="opacity-50" wire:key="row-{{ $tenencia->id }}">
                        ...
                        <x-table.cell>
                            ...
                            <span class="font-semibold">@if($tenencia->creadoPor != null)Registrado por: {{$tenencia->creadoPor->name}} @else Registro: @endif</span> <br>
                        ...
                        <x-table.cell>
                            ...
                            <span class="font-semibold">@if($tenencia->actualizadoPor != null)Actualizado por: {{$tenencia->actualizadoPor->name}} @else Actualizado: @endif</span> <br>
                        ...
                        <x-table.cell>
                            ...
                            <div class="flex justify-center lg:justify-start gap-2">
                                ...
                                @can('Editar tenencia')
                                    ...
                                    <x-button-blue
                                        wire:click="abrirModalEditar({{ $tenencia->id }})"
                                        wire:target="abrirModalEditar({{ $tenencia->id }})"
                                ...
                                @can('Borrar tenencia')
                                    ...
                                    <x-button-red
                                        wire:click="abrirModalBorrar({{ $tenencia->id }})"
                                        wire:target="abrirModalBorrar({{ $tenencia->id }})"
                                        wire:loading.attr="disabled"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4 mr-2">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
    ...
    <x-dialog-modal wire:model="modal" maxWidth="sm">
        ...
        <x-slot name="content">
            ...
            <div class="flex flex-col md:flex-row justify-between gap-3 mb-3">
                ...
                <x-input-group for="modelo_editar.distrito_id" label="Distrito" :error="$errors->first('modelo_editar.distrito_id')" class="w-full">

                    <x-input-select id="modelo_editar.distrito_id" wire:model="modelo_editar.distrito_id" class="w-full">
    ...
    <x-confirmation-modal wire:model="modalBorrar" maxWidth="sm">
        ...
        <x-slot name="content">
            ¿Esta seguro que desea eliminar la tenencia? No sera posible recuperar la información.
        </x-slot>
