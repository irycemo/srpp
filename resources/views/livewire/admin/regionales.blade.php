<div class="">
    ...
    <div class="overflow-x-auto rounded-lg shadow-xl border-t-2 border-t-gray-500">
        ...
        <x-table>
            ...
            <x-slot name="head">
                ...
                <x-table.heading >Ciudad</x-table.heading>
            ...
            <x-slot name="body">
                ...
                @forelse ($regionales as $regional)
                    ...
                    <x-table.row wire:loading.class.delaylongest="opacity-50" wire:key="row-{{ $regional->id }}">
                        ...
                        <x-table.cell>
                            ...
                            <span class="lg:hidden absolute top-0 left-0 bg-blue-300 px-2 py-1 text-xs text-white font-bold uppercase rounded-br-xl">Ciudad</span>
                        ...
                        <x-table.cell>
                            ...
                            <div class="flex justify-center lg:justify-start gap-2">
                                ...
                                @can('Editar regional')
                                    ...
                                    <x-button-blue
                                        wire:click="abrirModalEditar({{ $regional->id }})"
                                        wire:target="abrirModalEditar({{ $regional->id }})"
                                ...
                                @can('Borrar regional')
                                    ...
                                    <x-button-red
                                        wire:click="abrirModalBorrar({{ $regional->id }})"
                                        wire:target="abrirModalBorrar({{ $regional->id }})"
                                        wire:loading.attr="disabled"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4 mr-2">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
    ...
    <x-confirmation-modal wire:model="modalBorrar" maxWidth="sm">
        ...
        <x-slot name="content">
            ¿Esta seguro que desea eliminar la regional? No sera posible recuperar la información.
        </x-slot>
