    ...
    <div class="overflow-x-auto rounded-lg shadow-xl border-t-2 border-t-gray-500">
        ...
        <x-table>
            ...
            <x-slot name="body">
                ...
                @forelse ($ranchos as $rancho)

                    <x-table.row wire:loading.class.delaylongest="opacity-50" wire:key="row-{{ $rancho->id }}">
                        ...
                        <x-table.cell>
                            ...
                            <span class="font-semibold">@if($rancho->creadoPor != null)Registrado por: {{$rancho->creadoPor->name}} @else Registro: @endif</span> <br>
                        ...
                        <x-table.cell>
                            ...
                            <span class="font-semibold">@if($rancho->actualizadoPor != null)Actualizado por: {{$rancho->actualizadoPor->name}} @else Actualizado: @endif</span> <br>
                            ...
                            <div class="flex justify-center lg:justify-start gap-2">
                                ...
                                @can('Editar rancho')
                                    ...
                                    <x-button-blue
                                        ...
                                        wire:target="abrirModalEditar({{ $rancho->id }})"
                                ...
                                @can('Borrar rancho')
                                    ...
                                    <x-button-red
                                        ...
                                        wire:target="abrirModalBorrar({{ $rancho->id }})"
                                        wire:loading.attr="disabled"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4 mr-2">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
