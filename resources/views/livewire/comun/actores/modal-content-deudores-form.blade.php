<div class="space-y-3 p-3">
    ...
    <x-input-group for="tipos_deudor" label="Tipo de actor" :error="$errors->first('tipos_deudor')" class="w-full">

        <select class="bg-white rounded text-sm w-full h-36"
                wire:model="tipos_deudor"
                multiple="multiple">
