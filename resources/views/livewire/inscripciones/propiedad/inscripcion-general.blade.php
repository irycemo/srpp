                                        ...
                                        <x-table.cell>
                                            <div class="items-center gap-1 flex flex-col">
                                                <div>
                                                    ...
                                                    <livewire:comun.actores.propietario-actualizar :actor="$propietario" :predio="$inscripcion" wire:key="button-propietario-{{ $propietario->id }}" />
                                        ...
                                        <x-table.cell>
                                            <div class="flex flex-col items-center gap-3">
                                                <div>
                                                    ...
                                                    <livewire:comun.actores.representante-actualizar :actor="$representante" :predio="$inscripcion" wire:key="button-representante-{{ $representante->id }}" />
