<div>
    ...
    <x-header>Indices Varios</x-header>
    ...
    <div class="overflow-x-auto rounded-lg shadow-xl border-t-2 border-t-gray-500">
        ...
        <x-table>
            ...
            <x-slot name="body">
                ...
                @forelse ($varios as $vario)

                    <x-table.row wire:loading.class.delaylongest="opacity-50" wire:key="row-{{$vario->id }}">
                        ...
                        <x-table.cell>
                            ...
                            {{ Str::limit($vario->descripcion, 150) }}
                        ...
                        <x-table.cell>
                            ...
                            <div class="flex justify-center lg:justify-start gap-2">
                                ...
                                <x-button-green
                                    wire:click="abrirModalVer({{$vario->id }})"
                                    wire:target="abrirModalVer({{$vario->id }})"
                                    wire:loading.attr="disabled"
                                >
    ...
    <x-dialog-modal wire:model="modal" maxWidth="md">
        ...
        <x-slot name="title">Varios</x-slot>
