<div>
    ...
    <div class="grid grid-cols-3 gap-3">
        ...
        <div class="col-span-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mb-3 bg-white rounded-lg p-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mb-3 bg-white rounded-lg p-3">
                ...
                <span class="flex items-center justify-center text-lg text-gray-700 col-span-3">Datos Complementarios</span>
