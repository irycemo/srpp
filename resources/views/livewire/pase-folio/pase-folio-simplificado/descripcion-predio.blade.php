<div>
    ...
    <div class="gap-3">
        ...
        <div class="mb-3 col-span-2 bg-white rounded-lg p-3 shadow-lg">
            ...
            <span class="flex items-center justify-center text-lg text-gray-700 md:col-span-5 col-span-1 sm:col-span-2">Colindancias</span>

            <div class="mb-5 divide-y md:col-span-5 col-span-1 sm:col-span-2">
