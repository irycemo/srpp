    ...
    <main>
        ...
        <div class="container">
            ...
            <div>
                ...
                <p class="parrafo">
                    EL DIRECTOR DEL REGISTRO PÚBLICO DE LA PROPIEDAD @if($folioReal->distrito == '02 Uruapan' ) <strong>L.A. SANDRO MEDINA MORALES</strong> @else <strong>{{ $director }}</strong>, @endif certifica que habiendose examinado acervo registral correspondiente al distrito de {{ $folioReal->distrito}} se encontro registro de la siguiente propiedad:
                </p>
