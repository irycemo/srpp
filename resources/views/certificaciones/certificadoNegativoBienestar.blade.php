...
<body>
    ...
    <header>
        ...
        <img src="{{ public_path('storage/img/encabezado_bienestar.png') }}" alt="encabezado">
    ...
    <main>
        ...
        <div class="container">
            ...
            <div>
                ...
                <p class="parrafo">
                    EL DIRECTOR DEL REGISTRO PÚBLICO DE LA PROPIEDAD <strong>{{ $director }}</strong>, certifica que habiendose examinado el acervo registral de todo el estado de michoacán de ocampo,
                    no se encontro registro alguno a nombre de:
                </p>
