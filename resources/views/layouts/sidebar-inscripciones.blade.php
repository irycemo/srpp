    ...
    @can('Varios')
        ...
        <x-nav-dropdown>
            ...
            <x-slot name="body">
                ...
                <a  href="{{ route('varios_sin_porpiead') }}" class="capitalize font-medium text-sm flex items-center w-full py-2 px-4 focus:outline-rojo focus:outline-offset-2 rounded-lg">
