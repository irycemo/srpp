    ...
    <div class="relative max-h-screen md:flex">
        ...
        <div id="sidebar" class="z-10 bg-white w-64 absolute inset-y-0 left-0 transform -translate-x-full transition duration-200 ease-in-out md:relative md:translate-x-0">
            ...
            <nav class="p-4 text-rojo overflow-y-auto h-menu">
                ...
                @if(auth()->user()->hasRole(['Administrador', 'Operador', 'Director', 'Jefe de departamento certificaciones', 'Jefe de departamento inscripciones', 'Jefe de departamento jurídico', 'Supervisor uruapan', 'Operaciones', 'Supervisor inscripciones', 'Supervisor certificaciones']))
                ...
                @can('Pase a folio')
                    ...
                    @include('layouts.sidebar-pase-folio')

                @endif

                @can('Área Certificaciones')

                    @include('layouts.sidebar-certificaciones')
