...
trait InscripcionesIndex{
    ...
    public function ruta($movimientoRegistral){
        ...
        if($movimientoRegistral->inscripcionPropiedad){
            ...
            if(in_array($movimientoRegistral->inscripcionPropiedad->servicio, ['D121', 'D120', 'D123', 'D122', 'D119', 'D124', 'D126', 'D125'])){
    ...
    public function imprimir(MovimientoRegistral $movimientoRegistral){
        ...
        if($movimientoRegistral->estado !== 'autorizado' && !auth()->user()->hasRole(['Jefe de departamento inscripciones', 'Operaciones'])){
