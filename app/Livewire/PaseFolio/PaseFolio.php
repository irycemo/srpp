...
class PaseFolio extends Component
{
            ...
            DB::transaction(function (){
                ...
                if($this->modelo_editar->folioReal?->folioRealAntecedente?->matriz){
                    ...
                    if($this->modelo_editar->inscripcionPropiedad){
                        ...
                        $this->modelo_editar->inscripcionPropiedad->update(['descripcion_acto' => 'ESTE MOVIMIENTO REGISTRAL DA ORIGEN A ESTE FOLIO REAL.']);
    ...
    public function render()
    {
        ...
        if(auth()->user()->hasRole(['Administrador', 'Jefe de departamento inscripciones', 'Jefe de departamento certificaciones', 'Jefe de departamento inscripciones', 'Operaciones'])){
