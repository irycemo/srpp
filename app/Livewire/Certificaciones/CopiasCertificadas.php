        ...
        try {
            ...
            DB::transaction(function () use ($modelo){
                ...
                if(auth()->user()->hasRole(['Certificador Oficialia', 'Certificador Juridico'])){
                    ...
                    (new SistemaTramitesService())->finaliarTramite($this->modelo_editar->movimientoRegistral->año, $this->modelo_editar->movimientoRegistral->tramite, 'concluido');
    ...
    public function rechazar(){
        ...
        try {
            ...
            DB::transaction(function (){
                ...
                (new SistemaTramitesService())->rechazarTramite($this->modelo_editar->movimientoRegistral->año, $this->modelo_editar->movimientoRegistral->tramite, $observaciones);
