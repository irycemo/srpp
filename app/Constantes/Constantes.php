...
class Constantes{
    ...
    const ACTORES_FOLIO_REAL_PERSONA_MORAL = [
        ...
        'CONSEJERO(A) DE ASUNTOS ECONOMICOS Y DESARROLLO SOCIAL',
        'CONSEJERO(A) DE CULTURA',
        'CONSEJERO(A) DE DEPORTES',
        'CONSEJERO(A) DE ECOLOGIA Y MEDIO AMBIENTE',
        'CONSEJERO(A) DE EDUCACION',
        'CONSEJERO(A) DE EDUCACIÓN Y DEPORTES',
        ...
        'CONSEJERO(A) DE SEGURIDAD Y JUSTICIA SOCIAL',
        'CONSEJERO(A) DE SERVICIOS COMUNITARIOS',
