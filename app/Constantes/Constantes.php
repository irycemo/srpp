...
class Constantes{
    ...
    const ACTOS_INSCRIPCION_PROPIEDAD = [
        ...
        'CANCELACIÓN DE ESCRITURA / INSCRIPCIÓN',
    ...
    const ACTOS_INSCRIPCION_GRAVAMEN = [
        ...
        'CONTRATO DE SUSTITUCIÓN DE DEUDOR',
        'CÉDULA HIPOTECARIA'
    ];
    ...
    const ACTOS_INSCRIPCION_SENTENCIAS = [
        ...
        'CANCELACIÓN DE INSCRIPCIÓN DE PROPIEDAD',
    ];
    ...
    const SERVICIOS = [
        "Aclaraciones administrativas de inscripciones",
        "Acta constitutiva",
        "Acta de asamblea",
        "Aviso preventivo con certificado de existencia o inexistencia de gravamen",
        "Cancelación de gravamen",
        "CANCELACIÓN DE PRIMER AVISO PREVENTIVO",
        "Cancelación de reserva de dominio",
        "Certificado de gravamen",
        "Certificado de Gravamen o de Libertad de Gravamen",
        "Certificado de propiedad o negativo de propiedad por cada uno",
        "Certificado negativo de vivienda bienestar",
        "Certificados de propiedad o negativo de propiedad con descripción, medidas y linderos",
        "Consolidación del usufructo",
        "Consulta de antecedentes registrales",
        "Copias certificadas (por página)",
        "Copias simples (por página)",
        "Donación de usufructo",
        "Fraccionamientos, lotificaciones, habitacionales popular",
        "Fraccionamientos, lotificaciones, habitacionales tipo medio",
        "Fusión",
        "Genera nuevo folio real",
        "Gravamen",
        "Habitacional cuyo valor exceda $1,031,838.00",
        "Habitacional cuyo valor exceda $1,069,866.00",
        "Habitacional cuyo valor no exceda $1,031,838.00",
        "Habitacional cuyo valor no exceda $1,069,866.00",
        "Inscripción de demandas, sentencias juridicas y/o resoluciones, por cada inmueble afectado por la anotación",
        "Inscripción de fideicomiso",
        "Inscripción de gravámenes  por  créditos  para  la adquisición de vivienda de interés social",
        "Inscripción de gravámenes de bienes inmuebles",
        "Inscripción de gravámenes por créditos para la adquisición de vivienda de interés popular",
        "Inscripciones varios",
        "Inscripciones varios sin afectación de propiedad",
        "No habitacional rustico",
        "No habitacional urbano",
        "Por aclaraciones administrativas de inscripciones",
        "Reestructura de créditos",
        "Régimen de propiedad en condominio habitacional por cada vivienda",
        "Régimen de propiedad en condominio por local comercial",
        "Reserva de dominio",
        "Reversión o cancelación de fideicomiso",
        "Segundo aviso preventivo",
        "Subdivisiones por cada inmueble",
    ];
