...
namespace App\Http\Controllers\FolioPersonaMoralController;
...
class FolioPersonaMoralController extends Controller
{
    ...
    public function caratula(ReformaMoral $reforma)
    {
        ...
        if($reforma->movimientoRegistral->año){
        ...
        $canvas->page_text(35, 745, $reforma->movimientoRegistral->folioRealPersona->folio, null, 9, array(1, 1, 1));
    ...
    public function reimprimir(FirmaElectronica $firmaElectronica){
        ...
        $canvas->page_text(35, 745, $firmaElectronica->movimientoRegistral->folioRealPersona->folio, null, 9, array(1, 1, 1));
