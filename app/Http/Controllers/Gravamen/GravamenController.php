...
class GravamenController extends Controller
{
    ...
    public function caratula(Gravamen $gravamen)
    {
        ...
        $canvas->page_text(35, 745, $gravamen->movimientoRegistral->folioReal->folio  .'-' . $gravamen->movimientoRegistral->folio, $dom_pdf->getFontMetrics()->getFont('helvetica'), 9, array(1, 1, 1));
