...
class ReformaController extends Controller
{
    ...
    public function caratula(ReformaMoral $reforma)
    {
        ...
        $canvas->page_text(35, 745, 'PM-' . $reforma->movimientoRegistral->folioRealPersona->folio  .'-' . $reforma->movimientoRegistral->folio, $dom_pdf->getFontMetrics()->getFont('helvetica'), 9, array(1, 1, 1));
    ...
    public function reimprimir(FirmaElectronica $firmaElectronica){
        ...
        $canvas->page_text(35, 745, 'PM-' . $firmaElectronica->movimientoRegistral->folioRealPersona->folio . '-' .$firmaElectronica->movimientoRegistral->folio, $dom_pdf->getFontMetrics()->getFont('helvetica'), 9, array(1, 1, 1));
