...
class CancelacionController extends Controller
{
    ...
    public function caratula(Cancelacion $cancelacion)
    {
        ...
        $datos_control->folioReal = $cancelacion->movimientoRegistral->folioReal->folio;
        ...
        $canvas->page_text(35, 745, 'I-' . $cancelacion->movimientoRegistral->folioReal->folio  .'-' . $cancelacion->movimientoRegistral->folio, $dom_pdf->getFontMetrics()->getFont('helvetica'), 9, array(1, 1, 1));
