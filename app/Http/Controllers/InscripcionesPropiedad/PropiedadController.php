...
class PropiedadController extends Controller
{
    ...
    public function caratula(Propiedad $propiedad)
    {
        ...
        $datos_control->servicio = $this->nombreServicio($propiedad->movimientoRegistral->año, $propiedad->movimientoRegistral->tramite, $propiedad->movimientoRegistral->usuario);
        ...
        $canvas->page_text(35, 745, 'I-' . $propiedad->movimientoRegistral->folioReal->folio  .'-' . $propiedad->movimientoRegistral->folio, $dom_pdf->getFontMetrics()->getFont('helvetica'), 9, array(1, 1, 1));
