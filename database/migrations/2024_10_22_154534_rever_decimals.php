...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('predios', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('monto_transaccion', 15,4)->nullable()->change();
        });
        ...
        Schema::table('actors', function (Blueprint $table) {
            $table->unsignedDecimal('porcentaje_nuda', 15,4)->nullable()->change();
            $table->unsignedDecimal('porcentaje_usufructo', 15,4)->nullable()->change();
            $table->unsignedDecimal('porcentaje_propiedad', 15,4)->nullable()->change();
        });

        Schema::table('colindancias', function (Blueprint $table) {
            $table->unsignedDecimal('longitud', 15,4)->nullable()->change();
        });
